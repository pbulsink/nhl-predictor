...
One can find this applied to soccer and other sports with a quick google search. In particular, I like the work of Jonas at [opisthokonta.com](http://opisthokonta.net/?p=890). However, application of this work to hockey is less widely available. I will show an implementation of Dixon-Coles for NHL scores, and use the predicted values to simulate the remainder of the season, showing who has the best chances of winning the President's Trophy and of taking home the Stanley Cup. 
