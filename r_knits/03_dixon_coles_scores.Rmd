...
```{r}
# Expected goals home
lambda <- exp(res_2015$par['HOME'] + res_2015$par["Attack.Montreal Canadiens"] + res_2015$par["Defence.Montreal Canadiens"])
# Expected goals away
mu <- exp(res_2015$par["Attack.Toronto Maple Leafs"] + res_2015$par["Defence.Toronto Maple Leafs"])
```    
...
Next time we'll look at simulating a whole season.
