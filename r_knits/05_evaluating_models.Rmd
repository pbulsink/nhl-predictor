...
for (i in 1:length(xi_choice)){
    r<-doDCPrediction(train_2015, xi=xi_choice[i], currentDate=as.Date('2014-12-31'))
    adh<-as.matrix(getADHSeason(test_schedule, r, maxgoal=8))
    rpslist[paste("xi",xi_choice[i], sep=".")] <- rps(unlist(test_results), adh)
}
